...
use crate::bytes_ext::{BytesExt, LengthPrefixed};
...
mod parse {
    use super::*;
    // TODO(jooyung) add derive macro: #[derive(ReadFrom)]
    use crate::bytes_ext::ReadFrom;

    impl ReadFrom for Signer {
