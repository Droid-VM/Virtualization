...
pub(super) fn generate_certificate_request(
    ...
    info!("Successfully validated all '{}' public keys.", public_keys.len());
    ...
    info!("Successfully signed the CSR payload.");
    ...
    info!("Successfully built the CBOR authenticated request.");
