...
///
/// The keys of the map should be in canonical order as per RFC8949.
...
mod tests {
    ...
    /// The keys of device info map should be in canonical order as per RFC8949.
    /// The CBOR canonicalization rules are:
