...
use com_android_virt_service_vm_testservice::{
    aidl::com::android::virt::service_vm::testservice::IAttestationService::{
...
fn try_main() -> Result<()> {
    ...
    // SAFETY: This function only runs the RPC server for the valid service.
