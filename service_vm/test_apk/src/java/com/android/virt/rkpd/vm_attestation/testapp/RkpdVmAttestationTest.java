 ...
 *
 * <p>This test runs against the real RKP server and thus requires a stable network connection.
 *
 ...
 * keys are for AVF. 2. VM attestation: The test creates a VM with a payload binary that requests to
 * attest the VM, and then signs a message with the attestation key.
 *
 * <p>To run this test, you need to:
 *
 * <p>- Have an arm64 device supporting protected VMs. - Have a stable network connection on the
 * device. - Have the RKP server hostname configured in the device. If not, you can set it using: $
                    ...
                    public void onPayloadReady(VirtualMachine vm) {
                        ...
                        try {
                            ...
                            signingResultFuture.complete(
                                    service.signWithAttestationKey(MESSAGE.getBytes()));
                        } catch (Exception e) {
