...
import com.android.virt.service_vm.testservice.IAttestationService;

@RunWith(BlockJUnit4ClassRunner.class)
public class VmAttestationTests extends MicrodroidDeviceTestBase {
    private static final String TAG = "VmAttestation";
    ...
    public void requestingAttestationSucceeds() throws Exception {
        ...
        getVirtualMachineManager().provisionKeyPairForTesting();
