...
public class Application : AndroidApplication() {
    ...
    /**
     * Observes application lifecycle events and interacts with the VmLauncherService
     * to manage virtual machine state based on application lifecycle transitions.
     * This class binds to the VmLauncherService and notifies it of application
     * lifecycle events (onStart, onStop), allowing the service to manage the VM
     * accordingly.
     */
