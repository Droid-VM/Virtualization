...
public class MainActivity :
    ...
    private fun startVm() {
        ...
        if (Flags.terminalStorageBalloon()) {
            ...
            convertToNoSparseDiskIfNecessary(image)
        }
        ...
        val diskSize = intent.getLongExtra(KEY_DISK_SIZE, image.getApparentSize())
    ...
    private fun convertToNoSparseDiskIfNecessary(image: InstalledImage) {
        try {
            ...
            image.resize(intent.getLongExtra(KEY_DISK_SIZE, image.getApparentSize()))
        } catch (e: IOException) {
