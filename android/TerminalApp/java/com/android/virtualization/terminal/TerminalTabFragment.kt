...
class TerminalTabFragment(val id: String, val modifierKeysController: ModifierKeysController) :
    Fragment() {
                    ...
                    override fun onComplete(completedRequestId: Long) {
                        if (completedRequestId == requestId) {
                            ...
                            if (terminalGuiSupport()) {
                                (activity as MainActivity).displayMenu!!.visibility =
                                    View.VISIBLE
                                (activity as MainActivity).displayMenu!!.setEnabled(true)
                            }
                            (activity as MainActivity).bootCompleted.open()
