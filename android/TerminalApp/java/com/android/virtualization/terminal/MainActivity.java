...
public class MainActivity extends Activity implements VmLauncherServices.VmLauncherServiceCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "A VM instance is creating", Toast.LENGTH_SHORT).show();
    ...
    public void onVmStop() {
        Toast.makeText(this, "A VM instance is stopped, finish the app", Toast.LENGTH_SHORT).show();
        Log.i(TAG, "onVmStop()");
        finish();
    }

    public void onVmError() {
        Toast.makeText(this, "A VM instance is crashed, finish the app", Toast.LENGTH_SHORT).show();
        Log.i(TAG, "onVmError()");
        finish();
    }
