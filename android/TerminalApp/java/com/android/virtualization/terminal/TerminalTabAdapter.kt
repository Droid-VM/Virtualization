...
class TerminalTabAdapter(fragmentActivity: FragmentActivity) : FragmentStateAdapter(fragmentActivity) {
    val tabs = ArrayList<TabMetadata>()

    override fun createFragment(position: Int): Fragment {
        val terminalTabFragment = TerminalTabFragment()

        terminalTabFragment.arguments = bundleOf(
            "id" to tabs[position].id
        )
