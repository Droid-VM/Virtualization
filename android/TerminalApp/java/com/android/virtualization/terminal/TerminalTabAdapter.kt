...
class TerminalTabAdapter(fragmentActivity: FragmentActivity, private val modifierKeysController: ModifierKeysController) : FragmentStateAdapter(fragmentActivity) {
    val tabs = ArrayList<TabMetadata>()

    override fun createFragment(position: Int): Fragment {
        return TerminalTabFragment(tabs[position].id, modifierKeysController)
    }
