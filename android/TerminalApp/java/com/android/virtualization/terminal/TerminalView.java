            ...
            new AccessibilityDelegate() {
                ...
                public boolean onRequestSendAccessibilityEvent(
                    ...
                    switch (e.getEventType()) {
                            ...
                            // text
                            // on the terminal to the live region, which is very annoying to screen
                            // reader users.
                ...
                public AccessibilityNodeInfo createAccessibilityNodeInfo(int id) {
                    ...
                    switch (className) {
                        case "android.webkit.WebView":
                            ...
                            // virtual
                            // view hierarchy. The second one is a virtual view for the iframe. The
                            // latter one's text is set to the command that we give to ttyd, which
                            // is
                            // "login -f droid ...". This is an impl detail which doesn't have to be
                            // announced.  Replace the text with "Terminal display".
                            if (id != View.NO_ID) {
                                info.setText(null);
                            ...
                            // the
                            // WebView to be focusable by the reader. In our case, the EditText is
                            // a117_focusable.
                        ...
                        case "android.widget.TextView":
                            ...
                            // class="live-region">
                            // tag. Interestingly, its text is often populated with the entire text
                            // on
                            // the screen. Silence this by forcibly setting the text to null. Note
                            // that
                            // this TextView is identified by having a zero width. This certainly is
                            // not
                            // elegant, but I couldn't find other options.
                            Rect rect = new Rect();
