...
public class VmLauncherService extends Service implements DebianServiceImpl.DebianServiceCallback {
    ...
    private void showPortForwardingNotification(int port) {
        ...
        Icon icon = Icon.createWithResource(resources, R.drawable.ic_launcher_foreground);
        String notificationTitle =
                resources.getString(R.string.settings_port_forwarding_notification_title);
        String notificationContent =
                resources.getString(R.string.settings_port_forwarding_notification_content, port);
