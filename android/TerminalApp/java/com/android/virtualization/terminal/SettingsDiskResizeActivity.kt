...
<<<<<<< PATCH SET (e65709 VmTerminalApp: Fix a11y for resize slider)
                    /* defValue= */ 0))
...
>>>>>>> BASE      (4e6da0 Merge "Use current size as default value in shared perferenc)
        val minDiskSizeMb =
<<<<<<< PATCH SET (e65709 VmTerminalApp: Fix a11y for resize slider)
            bytesToMb(MainActivity.getMinFilesystemSize(partition))
||||||| BASE
