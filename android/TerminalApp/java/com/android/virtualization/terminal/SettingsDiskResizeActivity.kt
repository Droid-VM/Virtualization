...
class SettingsDiskResizeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val freeSpaceMb =
            bytesToMb(Environment.getDataDirectory().getFreeSpace()) and (diskSizeStepMb - 1).inv()
        val maxDiskSizeMb = defaultMaxDiskSizeMb.coerceAtMost(diskSizeMb + freeSpaceMb)
