...
use crate::dt_overlay::{extract_sk_public_key_from_host_ref_dt, ExtraDeviceTreeProperties, TrustedDeviceTreeProperties, UntrustedDeviceTreeProperties, VM_DT_OVERLAY_MAX_SIZE};
...
impl VirtualizationService {
    ...
    fn create_vm_internal(
        ...
        if let Some(dt_overlay) = extra_device_tree_properties
            .maybe_create_device_tree_overlay(&mut buffer, &temporary_directory)
            .or_service_specific_exception(-1)?
        {
