...
/// VM (i.e. AppConfig) requires it. However, a few Microdroid test uses RawConfig for Microdroid
/// VM. To handle the exceptional case, we use name as a second criteria; it the name is
/// "microdroid" we run VirtualMachineConfig
