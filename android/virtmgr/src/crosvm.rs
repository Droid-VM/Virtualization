...
fn run_vm(
    ...
    //
    // This is done to accommodate a limitation in a partner's hypervisor. We aren't ready allow
    // this to be configured via AVF APIs, so we do it by default for all VMs.
