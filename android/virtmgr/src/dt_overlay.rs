...
impl ExtraDeviceTreeProperties {
    pub(crate) fn new(
        ...
        Self {
            ...
            untrusted: UntrustedDeviceTreeProperties { defer_rollback_protection, instance_id },
        }
    }

    pub(crate) fn maybe_create_device_tree_overlay<'a>(
        &self,
        buffer: &'a mut [u8],
