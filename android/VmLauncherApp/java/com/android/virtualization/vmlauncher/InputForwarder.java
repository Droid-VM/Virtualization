...
class InputForwarder {
    ...
    InputForwarder(
        ...
        if (config.useSwitches()) {
            ...
            setupTabletModeHandler(context, touchReceiver.getHandler());
        }
    }
    ...
    private void setupTabletModeHandler(Context context, Handler handler) {
        InputManager im = context.getSystemService(InputManager.class);
        im.registerInputDeviceListener(
