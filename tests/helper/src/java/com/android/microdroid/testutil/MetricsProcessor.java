...
package com.android.microdroid.testutil;
...
public final class MetricsProcessor {
    ...
    /**
     * Gets the min, max, average and standard deviation of the given data and saves them in a Map
     * with their corresponding keys equal to [mPrefix + name + _[min|max|average|stdev]_ + unit].
     */
    public Map<String, Double> getStats(List<Double> metrics, String name, String unit) {
        double sum = 0;
