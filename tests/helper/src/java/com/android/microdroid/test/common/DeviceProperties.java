...
public final class DeviceProperties {
    ...
    private static final String KEY_VENDOR_DEVICE_NAME = "ro.product.vendor.device";
    ...
    public boolean isCuttlefish() {
        String vendorDeviceName = getProperty(KEY_VENDOR_DEVICE_NAME);
    ...
    private String getProperty(String key) {
        try {
            ...
            throw new IllegalArgumentException("Cannot to get property for the key: " + key);
        }
    }
}
