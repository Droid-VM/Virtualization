...
public final class AVFHostTestCase extends MicrodroidHostTestCaseBase {
    ...
    public void testBootEnableAndDisablePKVM() throws Exception {
        ...
        assumeTrue(isPKVMStatusSwitchSupported());
    ...
    private boolean isPKVMStatusSwitchSupported() throws Exception {
        String modelName = getDevice().getProperty("ro.product.model");

        Pattern p = Pattern.compile("Pixel [6-7][^0-9]*$", Pattern.CASE_INSENSITIVE);
