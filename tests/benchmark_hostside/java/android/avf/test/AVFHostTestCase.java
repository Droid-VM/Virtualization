...
public final class AVFHostTestCase extends MicrodroidHostTestCaseBase {
    ...
    private AmStartupTimeCmdParser getColdRunStartupTimes(CommandRunner android, String pkgName)
        ...
        String cmd = "for p in /sys/devices/system/cpu/cpufreq/policy*;" +
            " do echo 'echo '$(cat $p/scaling_governor)' > '$(echo $p/scaling_governor)';';done";
        ...
        android.run("for p in /sys/devices/system/cpu/cpufreq/policy*; do echo 'performance' > $p/scaling_governor; done");
