...
public final class AVFHostTestCase extends MicrodroidHostTestCaseBase {
    ...
    private static final int REINSTALL_APEX_RETRY_INTERVAL_MS = 10 * 1000;
    private static final int REINSTALL_APEX_TIMEOUT_SEC = 120;
    private static final int COMPILE_STAGED_APEX_RETRY_INTERVAL_MS = 10 * 1000;
    private static final int COMPILE_STAGED_APEX_TIMEOUT_SEC = 120;
    ...
    public void setUp() throws Exception {
        ...
        // Reboot to prevent previos staged session.
    ...
    private void compileStagedApex(int timeoutSec) throws Exception {
        ...
        while (true) {
            ...
            if (System.currentTimeMillis() > timeEnd) {
                ...
                throw new Exception("Failed to compile staged APEX.");
            }
    ...
    private void reInstallApex(int timeoutSec) throws Exception {
        ...
        while (true) {
            ...
            if (System.currentTimeMillis() > timeEnd) {
                ...
                throw new Exception("Failed to reinstall art APEX.");
            }
