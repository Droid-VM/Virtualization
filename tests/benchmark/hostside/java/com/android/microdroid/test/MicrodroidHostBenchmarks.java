...
public class MicrodroidHostBenchmarks extends MicrodroidHostTestCaseBase {
    ...
    public void testMicrodroidBootTime() throws Exception {
        ...
        mMetrics.addTestMetric("test_avf_metric_crosvm_start_time", "" + extractMonotonicLogTimeInMilliseconds("virtualizationservice::crosvm:[[:space:]]Running"));
        mMetrics.addTestMetric("test_avf_metric_vcpu_start_time", "" + extractMonotonicLogTimeInMilliseconds("MicrodroidConsole"));
        mMetrics.addTestMetric("test_avf_metric_kernel_start_time", "" + extractMonotonicLogTimeInMilliseconds("MicrodroidConsole:[[:space:]]Starting[[:space:]]kernel"));
        mMetrics.addTestMetric("test_avf_metric_payload_start_time", "" + extractMonotonicLogTimeInMilliseconds("MicrodroidConsole:.*microdroid_manager.*executing[[:space:]]main[[:space:]]task"));
