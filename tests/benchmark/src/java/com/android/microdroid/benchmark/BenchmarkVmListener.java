...
class BenchmarkVmListener extends VmEventListener {
    ...
    interface InnerListener {
        ...
        void onPayloadReady(VirtualMachine vm, IBenchmarkService benchmarkService) throws Exception;
    }
    ...
    public void onPayloadReady(VirtualMachine vm) {
        try {
            ...
            mListener.onPayloadReady(vm, service);
        } catch (Exception e) {
            Log.e(TAG, "Error inside VM#onPayloadReady():" + e);
