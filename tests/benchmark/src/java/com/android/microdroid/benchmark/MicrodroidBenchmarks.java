...
public class MicrodroidBenchmarks extends MicrodroidDeviceTestBase {
    ...
    private static class VsockVmEventListener extends VmEventListener {
        private static final int NUM_MB_TO_TRANSFER = 48;
        ...
        public void onPayloadReady(VirtualMachine vm) {
            try {
                ...
                benchmarkService.runVsockServerAndReceiveData(serverFd, NUM_MB_TO_TRANSFER);
        ...
        private double runVsockClientAndSendData(VirtualMachine vm) {
            try {
                ...
                double sendRate = IoVsockHostNative.measureSendRate(fd.getFd(), NUM_MB_TO_TRANSFER);
