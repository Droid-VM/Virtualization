    ...
    private static class VsockVmEventListener extends VmEventListener {
        ...
        public void onPayloadReady(VirtualMachine vm) {
            try {
                ...
                benchmarkService.runVsockServerAndReceiveData(serverFd);
                Log.i("abc", "port=" + mPort + " sendRate=" + sendRate.get());
        ...
        private double runVsockClientAndSendData(VirtualMachine vm) {
            try {
                ...
                double sendRate = IoVsockHostNative.sendData(fd.getFd());
