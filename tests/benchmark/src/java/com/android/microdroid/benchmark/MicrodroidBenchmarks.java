...
public class MicrodroidBenchmarks extends MicrodroidDeviceTestBase {
    ...
    private void collectVirtioBlkReadRates(VirtualMachine vm, Bundle bundle) {
        ...
        try {
            ...
            final String[] allIOBenchmarkKeys =
                    new String[] {
                        reportService.SEQ_READ_MEAN,
                        reportService.SEQ_READ_STD,
                        reportService.RAND_READ_MEAN,
                        reportService.RAND_READ_STD,
                    };
            for (String key : allIOBenchmarkKeys) {
                bundle.putDouble(metricNamePrefix + key + unit, reportService.getDouble(key));
            }
        } catch (Exception e) {
