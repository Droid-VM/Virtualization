...
public:
    ...
    ndk::ScopedAStatus runVsockServerAndReceiveData(int32_t server_fd, int32_t num_mb) override {
        auto res = io_vsock::run_vsock_server_and_receive_data(server_fd, num_mb);
        return resultStatus(res);
    }
