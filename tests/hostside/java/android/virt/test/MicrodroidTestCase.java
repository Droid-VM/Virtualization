...
public class MicrodroidTestCase extends BaseHostJUnit4Test {
    ...
    public void testMicrodroidBoots() throws Exception {
        ...
        // Create os_composite.img, env_composite.img, and payload_composite.img
        ...
        String makePayloadCompositeCmd =
                String.format(
                        "cd %s; %sbin/mk_payload %setc/microdroid_payload.json payload_composite.img",
                        TEST_ROOT, VIRT_APEX, VIRT_APEX);
        ...
        final String payloadCompositeImg = TEST_ROOT + "/payload_composite.img";
        CommandResult result =
                getDevice().executeShellV2Command("du -b " + osCompositeImg + " " + envCompositeImg + " " + payloadCompositeImg);
        ...
        String runMicrodroidCmd =
                String.format(
                        "cd %s; %sbin/crosvm run --cid=%d --disable-sandbox --bios=bootloader"
                                ...
                                + " --disk=env_composite.img --disk=payload_composite.img",
