...
public class MicrodroidTestCase extends BaseHostJUnit4Test {
    ...
    public void testMicrodroidBoots() throws Exception {
        // Prepare input files
        pushFile("microdroid.cdisk", "microdroid.cdisk");
        ...
        pushFile("metadata.img", "metadata.img");
        pushFile("misc.img", "misc.img");
        pushFile("userdata.img", "userdata.img");
        ...
        String makeOsCompositeCmd =
                String.format(
                        "cd %s; %sbin/mk_cdisk microdroid.cdisk os_header.img os_footer.img"
                                + " os_composite.img",
                        TEST_ROOT, VIRT_APEX);
