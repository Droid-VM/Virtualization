...
/**
 * Tests debug policy of pvmfw.img with.
 *
 * <p>This test assumes that pvmfw.img isn't overriden by --module-args.
 */
@RunWith(DeviceJUnit4ClassRunner.class)
public class PvmfwDebugPolicyHostTests extends MicrodroidHostTestCaseBase {
    @NonNull private static final String TAG = "PvmfwTest";

    @NonNull private static final String PVMFW_FILE_NAME = "pvmfw.bin";
    ...
    public void shutdown() throws Exception {
        ...
        clearCustomPvmfw(mCustomPvmfwBinFileOnHost);
    ...
    public void testRamdump() throws Exception {
        ...
        useCustomPvmfw(mCustomPvmfwBinFileOnHost);
        mMicrodroidDevice = launchProtectedVmAndWaitForCompleted();
    ...
    private static void useCustomPvmfw(@NonNull File fileOnHost) {
        runOnHost("adb", "push", fileOnHost.getPath(), CUSTOM_PVMFW_IMG_PATH);
        runOnHost("adb", "shell", "setprop", CUSTOM_PVMFW_IMG_PATH_PROP, CUSTOM_PVMFW_IMG_PATH);
    }

    private static void clearCustomPvmfw(@NonNull File fileOnHost) {
        FileUtil.deleteFile(fileOnHost);
        runOnHost("adb", "shell", "setprop", CUSTOM_PVMFW_IMG_PATH_PROP, "\"\"");
    }

    private ITestDevice launchProtectedVmAndWaitForCompleted() throws DeviceNotAvailableException {
        mMicrodroidDevice =
                MicrodroidBuilder.fromDevicePath(
                        ...
                        .addTestArtifacts(mCustomPvmfwBinFileOnHost, PVMFW_FILE_NAME)
