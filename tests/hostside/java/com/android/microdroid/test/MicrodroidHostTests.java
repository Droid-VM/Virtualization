...
public class MicrodroidHostTests extends MicrodroidHostTestCaseBase {
    ...
    private static class VmInfo {
        ...
        final Supplier<String> mCidSupplier;

        VmInfo(Process process, Supplier<String> cidSupplier) {
            mProcess = process;
            mCidSupplier = cidSupplier;
        }
    }
    ...
    private static String extractCidFrom(InputStream pis) {
        String cid = null;
        Pattern pattern = Pattern.compile("with CID (\\d+)");
        String line;
        try (BufferedReader out = new BufferedReader(new InputStreamReader(pis))) {
    ...
    public void testBootFailsWhenProtectedVmStartsWithImagesSignedWithDifferentKey()
        ...
        VmInfo vmInfo = runMicrodroidWithResignedImages(key, keyOverrides, /*isProtected=*/ true);
    ...
    public void testBootSucceedsWhenNonProtectedVmStartsWithImagesSignedWithDifferentKey()
        ...
        adbConnectToMicrodroid(getDevice(), vmInfo.mCidSupplier.get());
