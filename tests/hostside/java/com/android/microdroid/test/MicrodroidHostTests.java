...
public class MicrodroidHostTests extends MicrodroidHostTestCaseBase {
    ...
    private boolean isTombstoneGeneratedWithCrashPayload(String binaryName, boolean debuggable)
            throws Exception {
    ...
    public void testTombstonesAreGeneratedWithCrashPayload() throws Exception {
        assertThat(isTombstoneGeneratedWithCrashPayload("MicrodroidCrashNativeLib.so", true))
                .isTrue();
    }

    @Test
    public void testTombstonesAreNotGeneratedWithCrashPayloadWhenNonDebuggable() throws Exception {
        assertThat(isTombstoneGeneratedWithCrashPayload("MicrodroidCrashNativeLib.so", false))
                .isFalse();
    }

    @Test
    public void testTombstonesAreGeneratedWhenNonDebuggablePayloadWants() throws Exception {
        assertThat(isTombstoneGeneratedWithCrashPayload("MicrodroidCrashExportNativeLib.so", false))
                .isTrue();
    }
