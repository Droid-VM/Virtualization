...
public abstract class VirtualizationTestCaseBase extends BaseHostJUnit4Test {
    ...
    public void cleanUpVirtualizationTestSetup() throws DeviceNotAvailableException {
        ...
        // TODO(192660485): Figure out why stoppoing virtualizationservice disconnect adb on
        // cuttlefish, unexpectedly. Without this wait, the rest of test fails with assumption error
        // exception (because `skipIfFail("ls /dev/kvm");` fails).
