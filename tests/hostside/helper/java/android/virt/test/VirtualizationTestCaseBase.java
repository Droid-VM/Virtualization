...
public abstract class VirtualizationTestCaseBase extends BaseHostJUnit4Test {
    ...
    public void cleanUpVirtualizationTestSetup() throws DeviceNotAvailableException {
        ...
        // TODO: Figure out why stoppoing virtualizationservice disconnect adb on cuttlefish,
        // unexpectedly.
        runOnHostWithTimeout(10000, "adb", "wait-for-device");
    }
    ...
    private File findTestFile(String name) {
        try {
    ...
    public void rootMicrodroid() throws DeviceNotAvailableException {
        ...
        // TODO: Figure out the root cause and remove the sleep. For unknown reason, even though
        // `adb root` actually wait-for-disconnect then wait-for-device, the next
