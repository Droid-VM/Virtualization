...
fn test_boots() -> Result<(), Error> {
    android_logger::init_once(
        android_logger::Config::default().with_tag("ubootless").with_min_level(log::Level::Debug),
    );
        ...
        disks: vec![DiskImage {
            ...
            partitions: vec![
                Partition {
                    ...
                    image: Some(ParcelFileDescriptor::new(File::open(
                        "/apex/com.android.virt/etc/fs/microdroid_vbmeta.img",
                    )?)),
                    writable: false,
                },
                Partition {
                    ...
                    image: Some(ParcelFileDescriptor::new(File::open(
                        "/apex/com.android.virt/etc/fs/microdroid_super.img",
                    )?)),
                    writable: false,
                },
            ],
