...
public class MicrodroidTests extends MicrodroidDeviceTestBase {
    ...
    private VirtualMachineConfig buildVmConfigWithVendor(
            File vendorDiskImage, boolean isPermissionGranted) throws Exception {
        assumeSupportedDevice();
    ...
    public void configuringVendorDiskImageRequiresCustomPermission() throws Exception {
        ...
        VirtualMachineConfig config = buildVmConfigWithVendor(vendorDiskImage, false);
    ...
    public void bootsWithVendorPartition() throws Exception {
        ...
        VirtualMachineConfig config = buildVmConfigWithVendor(vendorDiskImage, true);
