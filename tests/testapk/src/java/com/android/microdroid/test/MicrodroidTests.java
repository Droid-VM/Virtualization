...
public class MicrodroidTests extends MicrodroidDeviceTestBase {
    ...
    @Test
    @CddTest(requirements = {"9.17/C-1-1", "9.17/C-2-1"})
    public void canReadFileFromAssets_debugNone() throws Exception {
        assumeSupportedKernel();
    ...
    private TestResults runVmTestService(VirtualMachine vm, RunTestsAgainstTestServices testsToRun)
            throws Exception {
        CompletableFuture<Boolean> payloadStarted = new CompletableFuture<>();
        CompletableFuture<Boolean> payloadReady = new CompletableFuture<>();
        TestResults testResults = new TestResults();
    ...
    @FunctionalInterface
    interface RunTestsAgainstTestServices {
