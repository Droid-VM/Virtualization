...
public class PvmfwImgTest extends CustomPvmfwHostTestCaseBase {
    @Test
    public void testPvmfw_withBefore1_2_whenSecretKeeperExists_bootFails() throws Exception {
    ...
    public ITestDevice launchProtectedVmAndWaitForBootCompleted(long adbTimeoutMs)
        ...
        return launchProtectedVmAndWaitForBootCompleted(MICRODROID_DEBUG_FULL, adbTimeoutMs, null);
    }
}
