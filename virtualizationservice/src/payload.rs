...
fn make_payload_disk(
    ...
    // Pass sorted list of apexes. Sorting key shouldn't use `path` because it will change after reboot with prefer_staged.
    // `last_update_seconds` is added to distinguish "samegrade" update.
