...
fn make_metadata_file(
    ...
    let payload_metadata = if let Some(payload_config) = &app_config.payloadConfig {
        PayloadMetadata::config(PayloadConfig {
        ...
        PayloadMetadata::config_path(format!("/mnt/apk/{}", app_config.configPath))
    };
