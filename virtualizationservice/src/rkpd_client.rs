...
pub(crate) fn get_attestation_key(client_vm_cid: i32) -> Result<RemotelyProvisionedKey> {
    ...
    registration.getKey(client_vm_cid, &get_key_callback).context("Failed to get key")?;
