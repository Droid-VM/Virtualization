...
use android_system_virtualizationservice_internal::aidl::android::system::virtualizationservice_internal::{
    ...
    IVirtualizationServiceHelper::IVirtualizationServiceHelper,
};
...
pub const BINDER_HELPER_SERVICE_IDENTIFIER: &str = "android.system.virtualizationservicehelper";
...
impl IVirtualizationServiceInternal for VirtualizationServiceInternal {
    ...
    fn bindDevicesToVfioDriver(&self, devices: &[String]) -> binder::Result<ParcelFileDescriptor> {
        ...
        let helper_service: Strong<dyn IVirtualizationServiceHelper> =
            wait_for_interface(BINDER_HELPER_SERVICE_IDENTIFIER)
                .expect("Could not connect to VirtualizationServiceHelper");
        helper_service.bindDevicesToVfioDriver(devices)
    }
}
