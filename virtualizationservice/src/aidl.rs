...
impl IVirtualizationServiceInternal for VirtualizationServiceInternal {
    ...
    fn requestAttestation(
        ...
        if cfg!(remote_attestation) {
            ...
            .with_log()
            .or_service_specific_exception(
                attestation_status_t::ATTESTATION_ERROR_PROVISIONED_KEYS_RETRIEVAL as i32,
            )?;
            ...
            let mut certificate_chain =
                vec![Certificate { encodedCertificate: attestation_key.encodedCertChain.clone() }];
