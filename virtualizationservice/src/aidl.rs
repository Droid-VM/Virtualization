...
use rkpd_client::get_rkpd_attestation_key_with_rpc_name;
...
impl IVirtualizationServiceInternal for VirtualizationServiceInternal {
    ...
    fn requestAttestation(&self, csr: &[u8], requester_uid: i32) -> binder::Result<Vec<u8>> {
        ...
        if cfg!(remote_attestation) {
            let attestation_key = get_rkpd_attestation_key_with_rpc_name(
            ...
            request_attestation(csr, &attestation_key.keyBlob, &attestation_key.encodedCertChain)
