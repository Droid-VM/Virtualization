...
pub const BINDER_VFIO_HANDLER_SERVICE_IDENTIFIER: &str = "android.system.vfio_handler";
...
impl IVirtualizationServiceInternal for VirtualizationServiceInternal {
    ...
    fn bindDevicesToVfioDriver(&self, devices: &[String]) -> binder::Result<ParcelFileDescriptor> {
        ...
        let vfio_service: Strong<dyn IVfioHandler> =
            wait_for_interface(BINDER_VFIO_HANDLER_SERVICE_IDENTIFIER)?;
