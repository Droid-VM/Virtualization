...
use crate::util::get_name_by_uid;
...
impl VmInstance {
    ...
    pub fn new(
        ...
        let requester_uid_name = get_name_by_uid(requester_uid)
            .unwrap_or_else(|| OsString::from(format!("{}", requester_uid)));
