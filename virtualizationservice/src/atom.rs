...
use statslog_virtualization_rust::{
    vm_booted, vm_cpu_status, vm_creation_requested, vm_exited, vm_mem_status,
};
...
pub fn write_vm_cpu_status_stats(
    ...
    let vm_cpu_status = vm_cpu_status::VmCpuStatus {
        uid,
        vm_identifier,
        cpu_time_user: cpu_status.cpu_time_user,
        cpu_time_nice: cpu_status.cpu_time_nice,
        cpu_time_sys: cpu_status.cpu_time_sys,
        cpu_time_idle: cpu_status.cpu_time_idle,
    };
    match vm_cpu_status.stats_write() {
        Err(e) => {
            warn!("statslog_rust failed with error: {}", e);
        }
        Ok(_) => trace!("statslog_rust succeeded for virtualization service"),
...
pub fn write_vm_mem_status_stats(
    ...
    let vm_mem_status = vm_mem_status::VmMemStatus {
        uid,
        vm_identifier,
        mem_total: mem_status.mem_total,
        mem_free: mem_status.mem_free,
        mem_available: mem_status.mem_available,
        mem_buffer: mem_status.mem_buffer,
        mem_cached: mem_status.mem_cached,
    };
    match vm_mem_status.stats_write() {
        Err(e) => {
            warn!("statslog_rust failed with error: {}", e);
        }
        Ok(_) => trace!("statslog_rust succeeded for virtualization service"),
