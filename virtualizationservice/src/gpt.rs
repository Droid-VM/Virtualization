...
pub const GPT_BEGINNING_SIZE: u64 = SECTOR_SIZE * 40; // TODO: Assert that this matches something.
pub const GPT_END_SIZE: u64 = SECTOR_SIZE * 33; // TODO: Assert that this matches something.
...
pub fn write_gpt_header(
    ...
    let mut write: &mut [u8] = &mut header_without_crc; // TODO: This looks weird
