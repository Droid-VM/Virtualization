...
Since Android U, AVF (with Microdroid) supports encrypted storage in a VM. This storage is mounted
at a path that can be retrieved via the [`AVmPayload_getEncryptedStoragePath()`][vm_payload_api].
...
even after updates to boot images and apks. This require chipsets to support [Secretkeeper 1.0 HAL interface][sk_hal_interface].
...
[sk_hal_interface]: https://cs.android.com/android/platform/superproject/main/+/main:hardware/interfaces/security/secretkeeper/aidl/android/hardware/security/secretkeeper/ISecretkeeper.aidl
