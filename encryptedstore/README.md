...
Since Android U, AVF (with Microdroid) supports Encrypted store which is the storage solution
...
### Integrity
Encrypted Store does not offer the level of integrity offered by primitives such as
