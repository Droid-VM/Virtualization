...
- Enable ramdump
- Enable `adb` connection and `adb logcat` output
...
- `/proc/device-tree/avf/guest/common/log`: Enable/disable console output.
- `/proc/device-tree/avf/guest/common/ramdump`: Enable/disable ramdump.
- `/proc/device-tree/avf/guest/microdroid/adb`: Enable/disable `adb` and\
  `adb logcat` output. Logcat output will be printed to console.
