...
First of all, push the signed APK and its idsig to the target device.

```sh
TEST_ROOT=/data/local/tmp/virt
adb push out/dist/MyApp.apk out/dist/MyApp.apk.idsig $TEST_ROOT
```
...
adb shell /apex/com.android.virt/bin/vm run-app $TEST_ROOT/MyApp.apk $TEST_ROOT/MyApp.apk.idsig assets/VM_CONFIG_NAME
```
