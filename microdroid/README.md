...
Copy the artifacts to the temp directory. In addition to that, some other files
have to be manually created, for now. In the future, you won't need these.
...
Create the composite image using `mk_cdisk` and run it via `crosvm`. In the
