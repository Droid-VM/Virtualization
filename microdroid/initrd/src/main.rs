...
enum Opt {
    ...
    Attach {
        ...
        initrd: PathBuf, // Input
        /// Bootconfigs
        bootconfigs: Vec<PathBuf>, // Input
        /// Output
        #[clap(long = "output")] // Output
        output: PathBuf,
    },

    // Detach the initrd & bootconfigs - this is required for cases when we update
    // bootconfigs in sign_virt apex
    Detach {
        /// Initrd (with bootconfigs)
        initrd_with_bootconfigs: PathBuf, // Input
        /// Initrd (without bootconfigs)
        initrd: PathBuf, // Output
        /// Bootconfigs
        bootconfigs: PathBuf, // Output
    },
}
