...
/// Notifies that the payload is ready.
#[no_mangle]
pub extern "C" fn notify_payload_ready(vsock_server: *const VsockServer) -> bool {
    let vsock_server = unsafe { ManuallyDrop::new(Rc::from_raw(vsock_server)) };
