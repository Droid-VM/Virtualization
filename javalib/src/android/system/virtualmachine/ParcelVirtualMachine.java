...
/**
 * A VM parcel that enables capturing the state of VM, transferring the state to a different App and
 * building an identical VM with the same state.
 *
 * <p>You can capture the current state of VM by creating an instance of this class with {@link
 * VirtualMachine#toParcelVirtualMachine()}, pass it to another App, and then build an identical VM
 * with the parcel received.
 *
 * @hide
 */
