...
public final class VirtualMachineDescriptor implements Parcelable, AutoCloseable {
    ...
    @NonNull private final ParcelFileDescriptor mInstanceIdFd;
    ...
    /**
     * @return File descriptor of the file containing the Id of the VM.
     */
    @NonNull
    ...
    VirtualMachineDescriptor(
            ...
            @NonNull ParcelFileDescriptor instanceIdFd,
        ...
        // TODO: Flag this
        mInstanceIdFd = requireNonNull(instanceIdFd);
    ...
    private VirtualMachineDescriptor(Parcel in) {
        ...
        mInstanceIdFd = requireNonNull(readParcelFileDescriptor(in));
