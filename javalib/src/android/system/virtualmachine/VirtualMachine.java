...
public class VirtualMachine {
    ...
    private VirtualMachine(Context context, String name, VirtualMachineConfig config) {
        ...
        mConfigFilePath = new File(vmRoot, CONFIG_FILE);
        mInstanceFilePath = new File(vmRoot, INSTANCE_IMAGE_FILE);
    }
    ...
    /* package */ static VirtualMachine create(
        ...
        // TODO(jiyong): trigger an error if the 'name' already exists.
    ...
    /* package */ static VirtualMachine load(Context context, String name)
            throws VirtualMachineException {
        // TODO(jiyong): trigger an error if the 'name' doesn't exist.
    ...
    public InputStream getConsoleOutputStream() throws VirtualMachineException {
        if (getStatus() != Status.RUNNING || mConsoleReader == null) {
            throw new VirtualMachineException(this + " is not running");
        }
