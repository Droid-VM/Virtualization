...
impl EcKey {
    ...
    fn generate_key(&mut self) -> Result<()> {
        ...
        validate_boringssl_return(
            unsafe { EC_KEY_generate_key(self.0) },
            BoringSSLApiName::EC_KEY_generate_key,
        )
    }
    ...
    fn check_key(&mut self) -> Result<()> {
        ...
        // point to a valid `EC_KEY`.
        validate_boringssl_return(
            unsafe { EC_KEY_check_key(self.0) },
            BoringSSLApiName::EC_KEY_check_key,
        )
    }
