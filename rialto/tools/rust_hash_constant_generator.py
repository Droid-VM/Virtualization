...
"""This script calculates the SHA512 hash of a file and writes it as a constant
in a Rust file.
...
array that contains the SHA512 hash of the input file. The constant can be used
...
def main():
    parser = argparse.ArgumentParser(
        description='Calculate SHA512 hash of a file and write as a constant' +
        'to a Rust file')
    ...
    # Calculate the SHA512 hash of the file's contents
