...
//! RemotelyProvisionedComponent HAL implementation.
...
pub fn new_binder() -> Strong<dyn IRemotelyProvisionedComponent> {
    BnRemotelyProvisionedComponent::new_binder(RkpVm {}, BinderFeatures::default())
}
...
impl IRemotelyProvisionedComponent for RkpVm {
    ...
    fn generateEcdsaP256KeyPair(
        ...
        // TODO(b/241429277): Implement this.
    ...
    fn generateCertificateRequest(
        ...
        Err(Status::new_service_specific_error_str(
            STATUS_REMOVED,
            Some("This methods was deprecated in v3 of the interface."),
        ))
    }
