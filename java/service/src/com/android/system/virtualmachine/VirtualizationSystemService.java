...
public class VirtualizationSystemService extends SystemService {
    ...
    @Override
    public void onStart() {
        publishBinderService(IVirtualizationTethering.DESCRIPTOR, mTetheringService);
    }
    ...
    private static final class TetheringService extends IVirtualizationTethering.Stub {
        @Override
        public void enableVirtualizationTethering() throws UnsupportedOperationException {
            throw new UnsupportedOperationException(
                    "Virtualization tethering is not supported yet");
        }
    }
}
