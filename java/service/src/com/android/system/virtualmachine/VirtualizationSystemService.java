...
public class VirtualizationSystemService extends SystemService {
    ...
    private final TetheringBinderService mTetheringBinderService;

    public VirtualizationSystemService(Context context) {
        super(context);
        mTetheringBinderService = new TetheringBinderService();
    }

    @Override
    public void onStart() {
        publishBinderService(IVirtualizationTethering.DESCRIPTOR, mTetheringBinderService);
    }
    ...
    private static final class TetheringBinderService extends IVirtualizationTethering.Stub {
        @Override
