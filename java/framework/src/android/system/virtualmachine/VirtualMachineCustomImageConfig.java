...
public class VirtualMachineCustomImageConfig {
    ...
    PersistableBundle toPersistableBundle() {
        ...
        pb.putPersistableBundle(
                KEY_DISPLAY_CONFIG,
                displayConfig != null ? displayConfig.toPersistableBundle() : null);
        return pb;
    }
    ...
    public static final class DisplayConfig {
        ...
        private static final String KEY_DISPLAY_CONFIG_HORIZONTAL_DPI =
                "display_config_horizontal_dpi";
        ...
        private static DisplayConfig from(PersistableBundle pb) {
            ...
            Builder builder = new Builder();
            builder.setWidth(pb.getInt(KEY_DISPLAY_CONFIG_WIDTH));
            builder.setHeight(pb.getInt(KEY_DISPLAY_CONFIG_HEIGHT));
            builder.setHorizontalDpi(pb.getInt(KEY_DISPLAY_CONFIG_HORIZONTAL_DPI));
            builder.setVerticalDpi(pb.getInt(KEY_DISPLAY_CONFIG_VERTICAL_DPI));
            builder.setRefreshRate(pb.getInt(KEY_DISPLAY_CONFIG_REFRESH_RATE));
            return builder.build();
        }

        private PersistableBundle toPersistableBundle() {
            PersistableBundle pb = new PersistableBundle();
            pb.putInt(KEY_DISPLAY_CONFIG_WIDTH, this.width);
            pb.putInt(KEY_DISPLAY_CONFIG_HEIGHT, this.height);
            pb.putInt(KEY_DISPLAY_CONFIG_HORIZONTAL_DPI, this.horizontalDpi);
            pb.putInt(KEY_DISPLAY_CONFIG_VERTICAL_DPI, this.verticalDpi);
            pb.putInt(KEY_DISPLAY_CONFIG_REFRESH_RATE, this.refreshRate);
            return pb;
        }
