...
//! Implementation of the AIDL interface `IVirtualMachinePayload`.

use android_system_virtualization_payload::aidl::android::system::virtualization::payload::IVirtualMachinePayload::{BnVirtualMachinePayload, IVirtualMachinePayload};
...
/// Implementation of `IVirtualMachinePayload`.
struct VirtualMachinePayload {
...
/// Registers the `IVirtualMachinePayload` service.
pub(crate) fn register_virtual_machine_payload_service(
