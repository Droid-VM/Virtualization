...
use openssl::md::Md;
use rpcbinder::run_initialized_unix_domain_rpc_server;
use std::sync::mpsc;
use std::thread;
...
pub(crate) fn register_vm_payload_service(
    ...
    thread::spawn(move || {
        let retval = run_initialized_unix_domain_rpc_server(
    ...
    match receiver.recv_timeout(Duration::from_millis(200)) {
        ...
        _ => bail!("Failed to register service '{}'", VM_PAYLOAD_SERVICE_NAME),
    }
}
