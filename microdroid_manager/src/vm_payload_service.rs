...
use coset::{iana, CoseSign, CoseSignBuilder, HeaderBuilder, CborSerializable, CoseSignatureBuilder,
    CoseKey, CoseKeyBuilder, CoseSignature};
use service_vm_comm::{Csr, CsrPayload};
use std::os::unix::io::OwnedFd;
use openssl::{
    ec::{EcGroup, EcKey, EcKeyRef}, nid::Nid, bn::{BigNumContext, BigNum}, sha::sha512,
...
mod tests {
    ...
    use openssl::{ec::EcPoint, pkey::Public};
