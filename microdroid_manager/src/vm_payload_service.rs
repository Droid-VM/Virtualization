...
struct Accessor {
    ...
    // So we need to keep track of where that service is.
    // FIXME how do we clean this up if the service goes away? Should we hold
    // a connection to the service as well to linkToDeath?
...
impl IAccessor for Accessor {
    fn connectToRpcSession(&self) -> binder::Result<ParcelFileDescriptor> {
        ...
        // SAFETY: we own the FD and want to pass ownership to the ParcelFileDescriptor.
        // FIXME make sure that's what this is actually doing...
