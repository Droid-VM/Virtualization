...
fn send_vm_status() -> Result<()> {
    ...
    loop {
        ...
        let vm_status = VirtualMachineStatus {
            // TODO(seungjaeyoo): move collecting cpu time info logic
        ...
        service.notifyCurrentStatus(&vm_status).expect("Can't send information about VM status");
