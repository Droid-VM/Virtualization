...
const SECRETKEEPER_KEY: &str = "/proc/device-tree/avf/secretkeeper-key";
...
fn try_run_payload(
    ...
    // TODO: We are calling host abot sk support multiple times, which introduces a security
    // vulnerability if host gives different answers. Fix this.
    // Also, Secret mechanism changes => Change secret to protect old ones!
