...
public final class ComposTestCase extends VirtualizationTestCaseBase {
    ...
    private String mSystemServerCompilerFilter;

    @Before
    public void setUp() throws Exception {
        testIfDeviceIsCapable(getDevice());

        mSystemServerCompilerFilter = getDevice().getProperty(
                SYSTEM_SERVER_COMPILER_FILTER_PROP_NAME);
        if (mSystemServerCompilerFilter == null) {
            mSystemServerCompilerFilter = "";
        }
    }
    ...
    public void tearDown() throws Exception {
        ...
        CLog.d("Restore dalvik.vm.systemservercompilerfilter to " + mSystemServerCompilerFilter);
