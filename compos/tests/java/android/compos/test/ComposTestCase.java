...
public final class ComposTestCase extends VirtualizationTestCaseBase {
    ...
    private static final String ART_APEX_DATA_DIR = "/data/misc/apexdata/com.android.art/";
    private static final String ODREFRESH_OUTPUT_DIR = ART_APEX_DATA_DIR + TEST_ARTIFACTS_DIR;
    private static final String ODREFRESH_STAGING_DIR = ART_APEX_DATA_DIR + "staging";
    ...
    public void tearDown() throws Exception {
        ...
        android.tryRun("rm", "-rf", ODREFRESH_STAGING_DIR);
    }
    ...
    public void testOdrefresh() throws Exception {
        ...
        String actualChecksumSnapshot = checksumDirectoryContentPartial(android,
                ODREFRESH_STAGING_DIR + "/dalvik-cache");
    ...
    private String checksumDirectoryContentPartial(CommandRunner runner, String path)
            throws Exception {
        // FIXME: cache-info.xml contains more APEXes and inconsistent timestamps. Not yet fixed?
        // Sort by filename (second column) to make comparison easier.
