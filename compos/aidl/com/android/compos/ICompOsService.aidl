...
interface ICompOsService {
     ...
     *
     * To keep ART indepdendantly updatable, the compilation arguments are not stablized. As a
     * result, the arguments are marshaled into byte array.  Upon recieved, the service asks ART to
