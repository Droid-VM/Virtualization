...
impl VmInstance {
    ...
    pub fn get_service(&self) -> Result<Strong<dyn ICompOsService>> {
        ...
        let ibinder = unsafe {
            ...
            // RpcPreconnectedClient does not take ownership of param, only passing it to request_fd.
...
impl FileHolder {
    ...
    fn as_void_ptr(&mut self) -> *mut std::os::raw::c_void {
    ...
    unsafe extern "C" fn request_fd(param: *mut ::std::os::raw::c_void) -> ::std::os::raw::c_int {
