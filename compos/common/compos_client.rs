...
pub struct VmInstance(vmclient::VmInstance);
...
impl VmInstance {
    ...
    pub fn start(
        ...
        let vm = vmclient::VmInstance::create(service, &config, console_fd, log_fd)
        ...
        vm.wait_until_ready(timeouts()?.vm_max_time_to_ready)?;
