...
class IsolatedCompilationMetrics {
    ...
    // TODO(b/218525257): Move the definition of this enum to atoms.proto
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({RESULT_SUCCESS, RESULT_UNKNOWN, RESULT_FAILED_TO_START, RESULT_JOB_CANCELED,
    ...
    public static void onCompilationScheduled() {
        // TODO(b/218525257): write to ArtStatsLog instead of logcat
        // ArtStatsLog.write(ArtStatsLog.ISOLATED_COMPILATION_SCHEDULED);
        Log.i(TAG, "ISOLATED_COMPILATION_SCHEDULED");
    }
    ...
    public void onCompilationEnded(@CompilationResult int result) {
        onCompilationEnded(result, null);
    }

    public void onCompilationEnded(@CompilationResult int result, @Nullable String message) {
        ...
        //                result, message, compilationTime);
        Log.i(TAG, "ISOLATED_COMPILATION_ENDED: " + result + ", " + message + ", "
                + compilationTime);
    }
