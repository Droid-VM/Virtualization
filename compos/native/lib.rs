...
mod crypto {
    ...
    struct KeyResult {
        /// The DER-encoded RSAPublicKey (https://datatracker.ietf.org/doc/html/rfc8017#appendix-A.1.1).
        public_key: Vec<u8>,
        /// The DER-encoded RSAPrivateKey (https://datatracker.ietf.org/doc/html/rfc8017#appendix-A.1.2).
    ...
    unsafe extern "C++" {
        ...
        // SAFETY: The C++ implementation manages its own memory. cxx handles the mapping of the return value.
