...
use vmbase::{
    ...
    layout::{
        console_uart_page, crosvm::FDT_MAX_SIZE, rodata_range, scratch_range, stack_range,
        text_range,
    },
    linker, logger, main,
    memory::{
...
pub fn main(arg0: u64, arg1: u64, arg2: u64, arg3: u64) {
    ...
    let bar_size = bar_region.len().try_into().unwrap();
    map_device(bar_region.start().0, bar_size).unwrap();
