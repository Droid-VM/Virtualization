...
function start-storageproxyd {
    start storageproxyd_test_system
}

function stop-storageproxyd {
    stop storageproxyd_test_system
    killall storageproxyd_test_system || true
}

function wipe-restart-storageproxyd {
    echo '[ -------- ] wipe-restart-storageproxyd'
    stop-storageproxyd
    rm /data/secure_storage_test_system/0
    start storageproxyd_test_system
}
...
# once the trusty_test_vm CID is identified, storageproxyd can be started
start-storageproxyd
