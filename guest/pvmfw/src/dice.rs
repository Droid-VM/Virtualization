...
use diced_open_dice::{
    bcc_handover_main_flow, hash, Config, DiceContext, DiceMode, Hash, InputValues, KeyAlgorithm,
    HIDDEN_SIZE, VM_KEY_ALGORITHM,
};
...
impl PartialInputs {
    ...
    pub fn write_next_bcc(
        ...
        let _ =
            bcc_handover_main_flow(current_bcc_handover, &dice_inputs, next_bcc, Some(context))?;
        Ok(())
    }
...
mod tests {
    ...
    use diced_open_dice::VM_KEY_ALGORITHM;
