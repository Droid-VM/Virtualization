...
/// # Safety
///
/// Callers of this metod need to ensure that the `efi_payload_start` is valid address of the EFI
...
pub fn execute_efi_payload(efi_payload_start: usize) -> Status {
    ...
    // SAFETY: 'efi_payload_start' should point to the valid location in memory.
