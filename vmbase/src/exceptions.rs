...
/// Handles an exception with the given ESR and FAR values.
pub fn handle_exception(esr: Esr, far: usize) -> Result<(), HandleExceptionError> {
...
/// Checks if the given ESR and FAR values correspond to a UART exception.
#[inline]
pub fn handling_uart_exception(esr: Esr, far: usize) -> bool {
