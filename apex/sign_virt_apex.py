...
def resign_rialto(args, key, rialto_path):
    ...
    assert original_descriptor['Digest'] != updated_descriptor['Digest'], \
        "Digest of rialto should be updated. Original digest: " \
        f"{original_descriptor['Digest']}, updated digest: {updated_descriptor['Digest']}"
...
def update_kernel_hashes_in_rialto(original_descriptors, args, files):
    ...
    assert original_kernel_digest == updated_kernel_digest, \
        f"Kernel digest should not change. Original digest: {original_kernel_digest}, " \
        f"updated digest: {updated_kernel_digest}"
