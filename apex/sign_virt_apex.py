...
def CheckNoSizeChangeOnResignedImage(image_path, original_image_info, resigned_image_info):
...
def AddHashFooter(args, key, image_path, partition_name, additional_descriptors=None):
    ...
    if info:
        ...
        CheckNoSizeChangeOnResignedImage(image_path, info, resigned_info)
...
def MakeVbmetaImage(args, key, vbmeta_img, images=None, chained_partitions=None):
    ...
    with tempfile.TemporaryDirectory() as work_dir:
        ...
        CheckNoSizeChangeOnResignedImage(vbmeta_img, info, resigned_info)
