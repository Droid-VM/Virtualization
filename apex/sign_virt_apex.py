...
def update_kernel_hashes_in_rialto(original_descriptors, args, files):
    ...
    original_kernel_descriptor = find_hash_descriptor_by_partition_name(original_descriptors, 'boot')
    updated_kernel_descriptor = find_hash_descriptor_by_partition_name(updated_descriptors, 'boot')
    assert_same_value(original_kernel_descriptor, updated_kernel_descriptor, "Digest",
                      "microdroid_kernel_hash_descriptor")
    ...
    for partition_name in partition_names:
        original_descriptor = find_hash_descriptor_by_partition_name(original_descriptors, partition_name)
        update_descriptor = find_hash_descriptor_by_partition_name(updated_descriptors, partition_name)
