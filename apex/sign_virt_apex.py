...
def check_no_size_change_on_resigned_image(image_path, original_image_info, resigned_image_info):
    ...
    assert_different_value(original_image_info, resigned_image_info, "Public key (sha1)",
                           image_path)
...
def resign_rialto(args, key, rialto_path):
    ...
    assert len(updated_prop) == 1 and original_prop == updated_prop, \
        "Prop should not change for rialto." \
