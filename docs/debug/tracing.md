...
The user space hypervisor tracing interface is located at /sys/kernel/tracing/hyp or at
/sys/kernel/debug/tracing/hyp. For the Android phones it will usually be /sys/kernel/tracing/hyp.
...
Note: the list above is not extensive
