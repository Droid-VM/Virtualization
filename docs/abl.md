...
ABL is not a component of AVF, but it plays a crucial role in loading the necessary AVF components
and initializing them in a correct way. This doc explains the responsibilities of ABL from the
perspective of AVF.
...
* verifying it as part of the verified boot process,
...
* DTBO describing [debug policy](docs/debug/README.md#debug-policy) (if available)
* DTBO describing [assignable devices](docs/device_assignment.md) (if available)
