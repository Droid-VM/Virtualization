...
For ChromiumOS, you can ssh-in. Check your IP address of ChromiumOS VM from
ethernet network setting page and follow commands below.
As of today, the ID and the password is `root` and `test0000` respectively.
