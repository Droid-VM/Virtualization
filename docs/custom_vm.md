...
Try use following URL, which downloads ferrochrome test image with version `R128-15926.0.0`.
https://storage.googleapis.com/chromiumos-image-archive/ferrochrome-public/R128-15926.0.0/chromiumos_test_image.tar.xz
You can download other version by replacing `R128-15926.0.0` with yours.

To find the latest green version, check
https://storage.googleapis.com/chromiumos-image-archive/ferrochrome-public/LATEST-main

To navigate build servers, [install gsutil](https://cloud.google.com/storage/docs/gsutil_install).
