...
your company have early access to Android source tree, you **CANNOT** follow
this instruction. In that case, you can only **USE** the AVF that is shipped in
the Android 13 Beta Image.

This is because AVF in the beta image is signed by Google and therefore it can't
be updated to a new AVF built in AOSP which can't be signed by the Googlg key
