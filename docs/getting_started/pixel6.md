...
This documentation provides steps for building AVF from AOSP, and then install
it to Pixel 6 series to better understand AVF and do some experiments.

**WARNING** Unless Android 13 is release to AOSP (expected to be at Summer 2022,
exact date TBD) by the time when you read this documentation, or you or your
company have early access to Android source tree, you **CANNOT** follow this
instruction. In that case, you can only **USE** the AVF that is shipped in the
Android 13 Beta Image.

This is because AVF in the beta image is signed by Google and therefore it can't
be updated to a new AVF built in AOSP which is signed by a non-Google test key.

## Upgrade to Android 13 Beta Image

Install Android 13 Beta Image to your Pixel 6 or Pixel 6 Pro device. This can be
done in two ways:
...
Enable ADB debugging in "Settings" -> "System" -> "Developer options". Then
enable PKVM.
...
Prepare your Android 13 (Tiramisu) branch.
