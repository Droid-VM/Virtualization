...
a device which boots the kernel in EL2 and the kernel was built with KVM enabled. At this moment,
we support the following two devices:

* aosp_cf_x86_64_phone (Cuttlefish a.k.a. Cloud Android)
* aosp_oriole_pkvm (Pixel 6)
...
```shell
source build/envsetup.sh
lunch aosp_oriole_pkvm
m
```

Flash it following https://source.android.com/setup/build/running
