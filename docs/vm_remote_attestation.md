...
2. Include `avf.remote_attestation.disabled=1` in the system properties
to disable the feature at boot-time.

If you don't set any of these variables, VM remote attestation will be enabled by
default.
