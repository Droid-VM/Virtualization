...
examines the presence of the RKP VM marker within the DICE certificates to
determine the origin of the chain, confirming that it indeed originates from the
RKP VM. For more detailed information about the RKP VM marker, please refer to
the [Remote Provisioning HAL][rkp-hal] spec.
