...
fn main(
    ...
    tt!(dice_inputs.write_next_bcc(truncated_bcc_handover.as_slice(), &salt, next_bcc)).map_err(
        |e| {
    ...
    tt!(modify_for_next_stage(fdt, next_bcc, new_instance, strict_boot, debug_policy, debuggable))
        .map_err(|e| {
