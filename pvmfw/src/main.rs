...
fn main(
    ...
    let verified_data = verify_payload(signed_kernel, ramdisk, PUBLIC_KEY).map_err(|e| {
    ...
    let next_bcc_size = derive_next_bcc(
        bcc,
        next_bcc,
        &verified_data.digests,
        verified_data.debug_level,
        PUBLIC_KEY,
    )
    .map_err(|e| {
