...
pub enum DeviceAssignmentError {
    ...
    /// DeviceAssigningHypervisor doesn't exist. Can't assign devices backed by host devices.
    NoDeviceAssigningHypervisor,
    /// Internal error
    Internal,
...
impl fmt::Display for DeviceAssignmentError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ...
            Self::NoDeviceAssigningHypervisor => write!(
                f, "Device Assigning hypervisor doesn't exist. Can't assign devices backed by host devices"
            ),
...
mod tests {
    ...
    fn device_info_new_without_hypervisor() {
        ...
        assert_eq!(device_info, Err(DeviceAssignmentError::NoDeviceAssigningHypervisor));
    }
}
