...
pub struct Entries<'a> {
    ...
    pub vm_reference_dt: Option<&'a [u8]>,
}
...
impl<'a> Config<'a> {
    ...
    pub fn get_entries(self) -> Entries<'a> {
        ...
        let [bcc, debug_policy, vm_dtbo, vm_reference_dt] = entries;
        ...
        let vm_reference_dt = vm_reference_dt.map(|x| &*x);

        Entries { bcc, debug_policy, vm_dtbo, vm_reference_dt }
    }
}
