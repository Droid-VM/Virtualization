...
fn validate_pci_irq_maps(pci_node: &libfdt::FdtNode) -> Result<(), RebootReason> {
    ...
    const FDT_PCI_FIRST_IRQ_NUMBER: u32 = 3;
    const GIC_SPI: u32 = 0;
    ...
    .enumerate()
    {
        let expected_addr_hi: u32 = i as u32 * (0x1 << (PCI_DEVICE_IDX - 1));
        let expected_irq_number: u32 = FDT_PCI_FIRST_IRQ_NUMBER + i as u32;
