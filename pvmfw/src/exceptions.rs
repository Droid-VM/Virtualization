...
impl From<usize> for Esr {
    fn from(esr: usize) -> Self {
        if esr == Self::ESR_32BIT_EXT_DABT {
            Self::DataAbortSyncExternalAbort
        } else if esr & Self::ESR_32BIT_TRANSL_FAULT_ISS_MASK == Self::ESR_32BIT_TRANSL_FAULT_BASE {
            Self::DataAbortTranslationFault
        } else if esr & Self::ESR_32BIT_PERM_FAULT_ISS_MASK == Self::ESR_32BIT_PERM_FAULT_BASE {
