...
pub fn kvm_mmio_guard_map(ipa: u64) -> smccc::Result<()> {
    ...
    // TODO(b/277859415): Drop the u32 to i64 conversion for MMIO_GUARD_MAP HVC64 once the
    // underlying hypervisor bug is fixed and upstreamed.
...
pub fn kvm_mmio_guard_unmap(ipa: u64) -> smccc::Result<()> {
    ...
    // TODO(b/277860860): Drop the hack for MMIO guard unmap hypercall once the
    // underlying hypervisor bug is fixed and upstreamed.
