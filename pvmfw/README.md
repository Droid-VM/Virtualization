...
Config header can provide a `DTBO` to be overlaid on top of the baseline device tree from crosvm.
    ...
    fragment@avf {
        ...
        __overlay__ {
            avf {
                guest {
                    common {
                        log = <1>;         /* Enables/disables console output. */
                        ramdump = <1>;     /* Enables/disables ramdump. */
                    };

                    microdroid {
                        adb = <1>;         /* Enables/disable adb and adb logcat outputs. */
                    };
                };
            };
        };
