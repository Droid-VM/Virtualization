...
use avb_bindgen::{AvbFooter, AvbVBMetaImageHeader, AVB_FOOTER_MAGIC, AVB_MAGIC, AVB_MAGIC_LEN};
...
fuzz_target!(|kernel_and_vbmeta: &[u8]| {
    ...
    let avb_footer = AvbFooter {
        ...
        magic: AVB_FOOTER_MAGIC[..(AVB_FOOTER_MAGIC.len() - 1)].try_into().unwrap(),
        version_major: 1,
        version_minor: 0,
        original_image_size: kernel_size as u64,
        vbmeta_offset: kernel_size as u64,
