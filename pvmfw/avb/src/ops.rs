...
extern "C" fn read_rollback_index(
    ...
    // TODO(278067832) : Refine this comment once capability for rollback protection is defined.
...
impl AvbSlotVerifyDataWrap {
    ...
    pub(crate) fn rollback_indexes(&self) -> Result<&[u64], avb::SlotVerifyError> {
        Ok(&self.as_ref().rollback_indexes)
    }
}
