...
pub fn verify_payload(
    ...
    let debug_level = if payload.verify_partition(PartitionName::InitrdNormal.as_cstr()).is_ok() {
        ...
        // TODO(b/256148034): This is temporary because throwing the error
        // AvbSlotVerifyError::Verification makes many tests flaky for the moment.
        // So we return DebugLevel::Full temporarily just to unblock other changes.
        return Ok(DebugLevel::Full);
    };
    Ok(debug_level)
}
