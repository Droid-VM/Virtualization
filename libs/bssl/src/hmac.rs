...
const SHA256_LEN: usize = Digester::Sha256.hash_len();
...
///
/// The output size `HASH_LEN` should correspond to the length of the hash function
/// output in octets.
fn hmac<const HASH_LEN: usize>(
    ...
    assert_eq!(digester.hash_len(), HASH_LEN);
