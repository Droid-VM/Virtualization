...
impl PKey {
    ...
    /// This function takes a raw public key data slice and allocates a new `EVP_PKEY` object
    /// from it.
    ///
    /// The lifetime of the returned instance is not tied to the lifetime of the raw public
    /// key slice because the data is copied into the `EVP_PKEY` object.
    ///
    ...
    pub fn new_raw_public_key(raw_public_key: &[u8], type_: Type) -> Result<Self> {
