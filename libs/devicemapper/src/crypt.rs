...
pub const AES256HCTR2_KEYSIZE: usize = 32;
pub const AES256XTS_KEYSIZE: usize = 64;
...
impl CipherType {
    ...
    fn validata_key_size(&self, key_size: usize) -> bool {
        match *self {
            // We use "plain64" as the IV/nonce generation algorithm -
            // which basically is the sector number.
            CipherType::AES256HCTR2 => key_size == AES256HCTR2_KEYSIZE,
            CipherType::AES256XTS => key_size == AES256XTS_KEYSIZE,
        }
    }
}
