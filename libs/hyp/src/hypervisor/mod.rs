...
pub fn mem_share(base_ipa: u64) -> Result<(), Error> {
...
/// [`hyp_meminfo`].
pub fn mem_unshare(base_ipa: u64) -> Result<(), Error> {
    kvm::mem_unshare(base_ipa)
}

pub(crate) fn mmio_guard_info() -> Result<u64, Error> {
    kvm::mmio_guard_info()
}

pub(crate) fn mmio_guard_enroll() -> Result<(), Error> {
    kvm::mmio_guard_enroll()
}

pub(crate) fn mmio_guard_map(ipa: u64) -> Result<(), Error> {
    kvm::mmio_guard_map(ipa)
}

pub(crate) fn mmio_guard_unmap(ipa: u64) -> Result<(), Error> {
