...
impl Hypervisor for GeniezoneHypervisor{
    ...
    fn mmio_guard_map(&self, addr: usize) -> Result<()> {
        ...
        success_or_error_32(hvc64(VENDOR_HYP_GZVM_MMIO_GUARD_MAP_FUNC_ID, args)[0] as u32)
            .map_err(|e| Error::GeniezoneError(e, VENDOR_HYP_GZVM_MMIO_GUARD_MAP_FUNC_ID))
    }
    ...
    fn mmio_guard_unmap(&self, addr: usize) -> Result<()> {
        ...
        match success_or_error_64(hvc64(VENDOR_HYP_GZVM_MMIO_GUARD_UNMAP_FUNC_ID, args)[0]) {
            Ok(_) => Ok(()),
            Err(e) => Err(Error::GeniezoneError(e, VENDOR_HYP_GZVM_MMIO_GUARD_UNMAP_FUNC_ID)),
        }
    }
