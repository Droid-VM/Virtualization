 ...
 *
 * This doesn't start the virtual machine automatically. To start virtual machine,
 * call {@link AVirtualMachine_start} explicitly.
 *
 ...
 * \param data an optional callback data passed by AVirtualMachine_start
 */
...
int AVirtualMachine_start(const AVirtualMachine* _Nonnull vm,
                          ...
                          const void* _Nullable data) __INTRODUCED_IN(36);
