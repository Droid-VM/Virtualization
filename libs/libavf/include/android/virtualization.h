...
typedef struct _AVirtualMachineConfig* AVirtualMachineConfig;
...
int AVirtualMachineConfig_createRawConfig(AVirtualMachineConfig* config);
void AVirtualMachineConfig_delete(AVirtualMachineConfig config);
...
int AVirtualMachineConfig_setMemoryMib(AVirtualMachineConfig config, int memory_mib);
...
int AVirtualMachineConfig_useHypervisorSpecificAuthMethod(AVirtualMachineConfig config);
int AVirtualMachineConfig_setCustomMemoryBackingFile(AVirtualMachineConfig config, int fd);
int AVirtualMachineConfig_addReservedMmioRange(AVirtualMachineConfig config, int rangeStart,
                                               int rangeEnd);

typedef struct _AVirtualizationService* AVirtualizationService;
...
void AVirtualizationService_delete(AVirtualizationService service);

typedef struct _AVirtualMachine* AVirtualMachine;
...
int AVirtualMachine_create(AVirtualizationService service, AVirtualMachineConfig config,
                           int consoleOutFd, int consoleInFd, int logFd, AVirtualMachine* pvm);
...
void AVirtualMachine_delete(AVirtualMachine vm);
