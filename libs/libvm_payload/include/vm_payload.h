 ...
 * Status type returned by while accessing RollbackProtectedSecret to indicate error.
 */
 ...
 *
 * \param buf A pointer to data to be written. This should have the size of atleast n bytes.
 ...
 *
 * \param buf pointer to buffer where the requested data is written.
