...
impl AvbImageVerifyError {
    fn from_avb_slot_verify_result(error_code: u32) -> Self {
        ...
        match error_code {
            ...
            AvbSlotVerifyResult_AVB_SLOT_VERIFY_RESULT_ERROR_IO => Self::Io,
            AvbSlotVerifyResult_AVB_SLOT_VERIFY_RESULT_ERROR_OOM => Self::Oom,
            AvbSlotVerifyResult_AVB_SLOT_VERIFY_RESULT_ERROR_PUBLIC_KEY_REJECTED => {
                Self::PublicKeyRejected
            }
            AvbSlotVerifyResult_AVB_SLOT_VERIFY_RESULT_ERROR_ROLLBACK_INDEX => Self::RollbackIndex,
            AvbSlotVerifyResult_AVB_SLOT_VERIFY_RESULT_ERROR_UNSUPPORTED_VERSION => {
                Self::UnsupportedVersion
            }
            AvbSlotVerifyResult_AVB_SLOT_VERIFY_RESULT_ERROR_VERIFICATION => Self::Verification,
...
impl AvbOps {
    ...
    fn verify_image(&self, image: &[u8], public_key: &[u8]) -> Result<(), AvbImageVerifyError> {
        ...
        match result {
            ...
            _ => Err(AvbImageVerifyError::from_avb_slot_verify_result(result)),
        }
    }
}
