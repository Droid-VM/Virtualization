...
use android_system_virtualizationservice::{
    ...
    aidl::android::system::virtualizationservice::CpuOptions::CpuOptions,
    aidl::android::system::virtualizationservice::CpuOptions::CpuTopology::CpuTopology,
...
impl VmConfig {
    ...
    pub fn to_parcelable(&self) -> Result<VirtualMachineRawConfig, Error> {
        ...
        // If cpu_topology is set, num of vcpus will match host. Else, default to 1
