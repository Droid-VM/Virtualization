...
/// Returns the pointer points to the VM context for DICE operations.
///
/// Within VMs, the context is always the same as a single key algorithm is used.
///
/// This function is used in bare-metal VMs such as RKP VM.
#[cfg(feature = "multialg")]
pub(crate) fn vm_context() -> *mut c_void {
    &VM_DICE_CONTEXT as *const DiceContext_ as *mut c_void
}

/// This function is used in regular VMs such as Microdroid VM.
...
pub fn dice_main_flow(
    ...
    // not used in pvmfw.
    #[cfg(feature = "multialg")]
    let context_ptr = &crate::dice::VM_DICE_CONTEXT as *const open_dice_cbor_bindgen::DiceContext_
