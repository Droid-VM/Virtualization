...
#[cfg(feature = "mutlialg")]
use crate::ops::{sign_cose_sign1, sign_cose_sign1_with_cdi_leaf_priv};
#[cfg(not(feature = "mutlialg"))]
use crate::ops::{sign_cose_sign1, sign_cose_sign1_with_cdi_leaf_priv};
...
pub fn retry_sign_cose_sign1(
    ...
    retry_with_measured_buffer(|encoded_signature| {
        sign_cose_sign1(message, aad, private_key, encoded_signature, key_algorithm)
    })
}
