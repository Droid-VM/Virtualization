...
pub fn keypair_from_seed(seed: &[u8; PRIVATE_KEY_SEED_SIZE]) -> Result<(PublicKey, PrivateKey)> {
    ...
    let mut context = open_dice_cbor_bindgen::DiceContext_ {
        subject_algorithm: open_dice_cbor_bindgen::DiceKeyAlgorithm::kDiceKeyAlgorithmEd25519,
        authority_algorithm: open_dice_cbor_bindgen::DiceKeyAlgorithm::kDiceKeyAlgorithmEd25519,
    };
    #[cfg(feature = "multialg")]
