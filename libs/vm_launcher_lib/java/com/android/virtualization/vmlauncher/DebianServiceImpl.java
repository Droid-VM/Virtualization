...
class DebianServiceImpl extends DebianServiceGrpc.DebianServiceImplBase {
    ...
    @Keep
    public class ForwarderHostCallback {
        ...
        public void onForwardingRequestReceived(int guestTcpPort, int vsockPort) {
    ...
    static native void runForwarderHost(int cid, ForwarderHostCallback callback);
