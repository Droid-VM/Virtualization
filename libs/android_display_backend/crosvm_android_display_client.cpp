...
public:
    ...
    ndk::ScopedAStatus setSurface(std::optional<aidl::android::view::Surface>* surface) override {
...

        {
            ...
            mSurface = std::make_unique<aidl::android::view::Surface>(surface->value().release());
        }
