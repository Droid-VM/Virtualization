...
pub use tracker::{
    deactivate_dynamic_page_tables, init_shared_pool, map_data, map_data_outside_main_memory,
    map_device, map_rodata, map_rodata_outside_main_memory, resize_available_memory,
