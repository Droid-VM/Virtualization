...
mod tests {
    ...
    #[test]
    fn fsverity_verify_full_read_16m() -> Result<()> {
        let file = &include_bytes!("../testdata/input.16m")[..];
        let merkle_tree = &include_bytes!("../testdata/input.16m.merkle_dump")[..];
    ...
    fn fsverity_verify_bad_merkle_tree() -> Result<()> {
        let file = &include_bytes!("../testdata/test.apk")[..];
        // First leaf node is corrupted.
        let merkle_tree = &include_bytes!("../testdata/test.apk.merkle_dump.bad")[..];
