...
use fusefs::{Inode, RemoteFileConfig};
...
fn new_config_remote_unverified_file(
    ...
    Ok(RemoteFileConfig::UnverifiedReadonly { reader, file_size })
}
...
fn new_config_remote_new_verified_file(
    ...
    Ok(RemoteFileConfig::VerifiedNew { editor: VerifiedFileEditor::new(remote_file) })
}

fn prepare_file_pool(args: &Args) -> Result<BTreeMap<Inode, RemoteFileConfig>> {
