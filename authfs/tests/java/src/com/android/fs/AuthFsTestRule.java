...
public class AuthFsTestRule extends TestLogData {
    ...
    static void startMicrodroid(ITestDevice androidDevice, IBuildInfo buildInfo)
            throws DeviceNotAvailableException {
        CLog.i("Starting the shared VM");
        sMicrodroidDevice =
                MicrodroidBuilder.fromFile(
                                findTestFile(buildInfo, TEST_APK_NAME), VM_CONFIG_PATH_IN_APK)
                        .debugLevel("full")
    ...
    static void shutdownMicrodroid(ITestDevice androidDevice) throws DeviceNotAvailableException {
        assertNotNull(sMicrodroidDevice);
        ((TestDevice) androidDevice).shutdownMicrodroid(sMicrodroidDevice);
