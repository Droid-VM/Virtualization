...
public final class AuthFsHostTest extends VirtualizationTestCaseBase {
    ...
    /** Directory that contains open_then_run executable. */
    private static final String OPEN_THEN_RUN_DIR = "/data/local/tmp/open_then_run";
    ...
    public void tearDown() throws DeviceNotAvailableException {
        ...
        sAndroid.tryRun("rm -rf " + TEST_OUTPUT_DIR + "/*");
    ...
    public void testOutputDirectory_CannotRecreateDirectoryIfNameExists() throws Exception {
        ...
        assertFalse(hasSucceededOnMicrodroid("mkdir " + authfsOutputDir + "/some_file"));
        assertFalse(hasSucceededOnMicrodroid("mkdir " + authfsOutputDir + "/some_dir"));
        assertFalse(hasSucceededOnMicrodroid("mkdir " + authfsOutputDir + "/some_dir/file"));
        assertFalse(hasSucceededOnMicrodroid("mkdir " + authfsOutputDir + "/some_dir/dir"));
    }
    ...
    private String getOpenThenRunPath() {
        ...
        return OPEN_THEN_RUN_DIR + "/" + mArch + "/open_then_run";
    }
