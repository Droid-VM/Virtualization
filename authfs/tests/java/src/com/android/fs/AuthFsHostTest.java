...
public final class AuthFsHostTest extends VirtualizationTestCaseBase {
    ...
    private static final int AUTHFS_INIT_TIMEOUT_MS = 5000;
    ...
    private void runFdServerOnAndroid(String execParamsForOpeningFds, String flags)
        ...
        // FIXME The client of a RPC binder server needs to wait until the server starts to listen.
        try {
            Thread.sleep(3000);
