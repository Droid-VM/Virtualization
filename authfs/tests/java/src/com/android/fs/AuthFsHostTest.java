...
public final class AuthFsHostTest extends BaseHostJUnit4Test {
    ...
    private boolean copyFileInGuest(String src, String dest) throws DeviceNotAvailableException {
        // TODO(victorhsieh): cp returns error because close(2) returns ENOSYS in the current authfs
    ...
    private void runFdServerInBackground(String execParamsForOpenningFds, String flags)
            throws DeviceNotAvailableException {
        String cmd = "cd " + TEST_DIR + " && exec " + execParamsForOpenningFds + " " + FD_SERVER_BIN
                + " " + flags;
        mThreadPool.submit(() -> {
            try {
