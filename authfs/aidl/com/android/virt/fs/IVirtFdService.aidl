...
interface IVirtFdService {
     ...
     *
     * @param basename The file name to create. Should not contain directory separator.
     * @return file ID that represent the new created file.
     */
     ...
     *
     * @param basename The directory name to create. Should not contain directory separator.
     * @return file ID that represent the new created directory.
     */
    int mkdir(int id, String basename);
}
