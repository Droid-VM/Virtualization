...
copy_android_config() {
	...
	append_rust_binary_to_config forwarder_guest
	append_rust_binary_to_config forwarder_guest_launcher
	append_rust_binary_to_config ip_addr_reporter
}
