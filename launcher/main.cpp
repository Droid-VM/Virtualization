...
constexpr char entrypoint_name[] = NAME_TO_STRING(android_native_main);
...
int main(int argc, char* argv[]) {
    ...
    android_native_main_t* entry = nullptr;
    entry = reinterpret_cast<decltype(entry)>(dlsym(handle, entrypoint_name));
    if (entry == nullptr) {
