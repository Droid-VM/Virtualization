...
fn run_vm(
    ...
    let device_tree_dump = add_preserved_fd(&mut preserved_fds, &config.device_tree_dump);
    command.arg(format!("--dump-device-tree-blob={}", &device_tree_dump));
