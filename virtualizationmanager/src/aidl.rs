...
impl VirtualizationService {
    ...
    fn create_vm_internal(
        ...
        // Currently, VirtMgr adds the host copy of reference DT & an untrusted prop (instance_id)
        ...
        if cfg!(llpvm_changes) {
            ...
            untrusted_props.push((cstr!("instance_id"), &instance_id[..]));
            if is_secretkeeper_supported() {
                ...
                untrusted_props.push((cstr!("defer_rbp"), &[]))
            }
        }
