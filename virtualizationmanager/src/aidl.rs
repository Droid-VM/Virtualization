...
const MAX_DT_ADDITIONS: usize = 2;
...
impl VirtualizationService {
    ...
    fn create_vm_internal(
        ...
        let mut dt_additions = Vec::with_capacity(MAX_DT_ADDITIONS);
        ...
        if cfg!(llpvm_changes) {
            ...
            dt_additions.push(DtAddition::AvfUntrustedProp(cstr!("instance-id"), &id[..]));
        }
