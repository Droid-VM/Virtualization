...
impl DebugConfig {
    pub fn new(config: &VirtualMachineConfig) -> Self {
        ...
        let dt_dump_sysprop = system_properties::read_bool(DUMP_DT_SYSPROP, false);
        let dump_device_tree = dt_dump_sysprop.unwrap_or_else(|e| {
    ...
    fn get_debug_policy() -> Option<DebugPolicyConfig> {
