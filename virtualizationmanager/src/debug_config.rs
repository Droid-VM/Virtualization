                ...
                if let Some(fdt) = FdtWrapper::from_overlay_onto_new_fdt(&debug_policy_path) {
                    ...
                    let debug_config = Self {
                        ...
                        debug_policy_log: fdt
                            .get_fdt_prop_bool(DEBUG_POLICY_LOG_PATH)
                            .unwrap_or_default(),
                        debug_policy_ramdump: fdt
                            .get_fdt_prop_bool(DEBUG_POLICY_RAMDUMP_PATH)
                            .unwrap_or_default(),
                        debug_policy_adb: fdt
                            .get_fdt_prop_bool(DEBUG_POLICY_ADB_PATH)
                            .unwrap_or_default(),
                    };
                    info!("Loaded custom debug policy: {:?}", debug_config);
