...
// shared library named `paylaod_binary_name` in the apk `main_apk_path`. Alternatively, you may
// construct VirtualMachineRawConfig which allows you to run any custom OS. This app doesn't
