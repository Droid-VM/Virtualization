 ...
 */
size_t AVmPayload_getPrivateKeyFromResult(const struct AVmAttestationResult* _Nonnull result,
 ...
 */
size_t AVmPayload_signWithAttestedKey(const struct AVmAttestationResult* _Nonnull result,
 ...
 */
size_t AVmPayload_getCertificateChainFromResult(const struct AVmAttestationResult* _Nonnull result,
                                                void* _Nullable data, size_t size)
        __INTRODUCED_IN(__ANDROID_API_V__);
