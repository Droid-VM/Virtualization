 ...
 *
 * \return attestation_status_t::ATTESTATION_OK on successful attestation.
 */
 ...
 *
 * \return a constant string value representing the status code.
 */
 ...
 */
void AVmPayload_freeAttestationResult(struct AVmAttestationResult* _Nonnull result)
        __INTRODUCED_IN(__ANDROID_API_V__);
 ...
 */
size_t AVmPayload_getPrivateKeyFromResult(struct AVmAttestationResult* _Nonnull result,
 ...
 */
size_t AVmPayload_signWithAttestedKey(struct AVmAttestationResult* _Nonnull result,
 ...
 */
size_t AVmPayload_getCertificateChainFromResult(struct AVmAttestationResult* _Nonnull result,
                                                void* _Nullable data, size_t size)
        __INTRODUCED_IN(__ANDROID_API_V__);
