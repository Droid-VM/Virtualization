 ...
 * virtualizationservice and will be used in |AVmPayload_requestAttestationForTesting|.
 */
void AVmPayload_provisionKeyForTesting(void) __INTRODUCED_IN(__ANDROID_API_V__);
