...
under the `lib` directory, like other JNI code.
...
- The [NdkBinder
  ...
  [vm_payload.h](include/vm_payload.h), and cannot connect to any binder
  server. Passing file descriptors to and from the VM is not supported.
