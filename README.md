...
* [Microdroid kernel](build/microdroid/kernel/README.md)
* [Microdroid payload](libs/libmicrodroid_payload/README.md)
* [vmbase](libs/vmbase/README.md)
* [Encrypted Storage](guest/encryptedstore/README.md)
* [Service VM](docs/service_vm.md)

AVF APIs:
* [Java API](android/java/framework/README.md)
* [VM Payload API](libs/libvm_payload/README.md)

How-Tos:
* [Building and running a demo app in Java](android/demo/README.md)
* [Building and running a demo app in C++](android/demo_native/README.md)
