...
use android_system_virtmanager::{
    ...
    aidl::android::system::virtmanager::Partition::Partition as AidlPartition,
    ...
    pub fn validate(&self) -> Result<(), Error> {
        ...
        for disk in &self.disks {
            ...
            if disk.qcow2 && !disk.writable {
                bail!("qcow2 only makes sense for writable disks. (Was {:?}.)", disk);
            }
        }
        Ok(())
    }
...
// TODO: Share this type with virtmanager::composite::config.
